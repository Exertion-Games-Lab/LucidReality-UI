  ...
  return (
    <>
      ...
      <ApplicationProvider {...eva} theme={{ ...eva.dark, ...theme }}>
        <Stack.Screen options={{ title: 'Intro to LD' }} />
        <Layout style={styles.container}>
          <ScrollView>

            <Card style={styles.card}>
              <Text category='h5'>What is Lucid Dreaming?</Text>
            ...
            <Card style={styles.card}>
              <Text category='h5'>When do Lucid Dreams Happen?</Text>
            ...
            <Card style={styles.card}>
              <Text category='h5'>Benifits of lucid dreaming</Text>
              <Text category='p1'> Benefits here</Text>
            </Card>

            <Card style={styles.card}>
              <Text category='h5'>Dangers of lucid dreaming</Text>
