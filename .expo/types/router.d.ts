...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/(connect)/Connect` | `/Connect` | `/(tabs)/(connect)/_layout` | `/_layout` | `/(tabs)/(connect)/` | `/(tabs)/(connect)` | `/(tabs)/(connect)/userGuideHeadset` | `/userGuideHeadset` | `/(tabs)/(connect)/userGuideServer` | `/userGuideServer` | `/(tabs)/(home)/_layout` | `/(tabs)/(home)/cognitiveTraining` | `/cognitiveTraining` | `/(tabs)/(home)/index.d` | `/index.d` | `/(tabs)/(home)/` | `/(tabs)/(home)` | `/(tabs)/(home)/introToLD` | `/introToLD` | `/(tabs)/(home)/introToSystem` | `/introToSystem` | `/(tabs)/(home)/lucidDream` | `/lucidDream` | `/(tabs)/(home)/nap` | `/nap` | `/(tabs)/(home)/overnight` | `/overnight` | `/(tabs)/(home)/playVR` | `/playVR` | `/(tabs)/(home)/stayAwake` | `/stayAwake` | `/(tabs)/(home)/uninterruptedSleep` | `/uninterruptedSleep` | `/(tabs)/(home)/videoGuideHeadset` | `/videoGuideHeadset` | `/(tabs)/(journal)/_layout` | `/(tabs)/(journal)/` | `/(tabs)/(journal)` | `/(tabs)/_layout` | `/+html` | `/modal`;
  // prettier-ignore
